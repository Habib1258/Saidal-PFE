            ...
            <div class="navbar-end">
                ...
                <div class="navbar-item">
                    <div class="buttons">
                        ...
                        <a class="button is-normal  is-instagram is-warning" href="https://www.instagram.com/groupesaidal/">
                            <span class="icon">
                                <i class="fab fa-instagram fa-lg"></i>
                            </span>
                        </a><a class="button is-normal  is-twitter is-info" href="https://twitter.com/groupesaidal?lang=fr">
                            <span class="icon">
            ...
            <div class="container">
                <div class="columns is-centered">
                    <div class="slogan column is-full">
                        <img src="img/ban_saidal.png" alt="banner" style="margin-left:6rem ;
                         width:1100px;
                         padding-left:3rem; ">
                    </div>
                </div>
                ...
                <div class="columns is-centered">
                        ...
                        <div class="card">
                            <div class="card-image">
                                <figure class="image is-4by3">
                                    <img src="img/stagepic.jpg" alt="Stage">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        <p class="title is-4">STAGE</p>
                                    </div>
                                </div>

                                <div class="content">
                                    <p>
                                        " Réussir votre entrée dans la vie professionnelle "
                                    </p>
                                    <br>
                                    <a class="button is-info" href="landing_stage.php">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        <div class="card">
                            <div class="card-image">
                                <figure class="image is-4by3">
                                    <img src="img/recrutementpic.jpg" alt="Recrutement">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        <p class="title is-4">Recrutement</p>
                                    </div>
                                </div>
                                ...
                                <div class="content">
                                    ...
                                    <br>
                                    <a class="button is-info" href="landing_rec.php">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        <div class="card">
                            <div class="card-image">
                                <figure class="image is-4by3">
                                    <img src="img/offre.jpg" alt="Offre">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        <p class="title is-4">Formation</p>
                                    </div>
                                </div>
                                ...
                                <div class="content">
                                    ...
                                    <br>
                                    <a class="button is-info" href="landing_form.php">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
