...
$sql = "SELECT * FROM news WHERE genre='recrutement' ";
...
$sql = "SELECT * FROM news WHERE genre='recrutement' LIMIT " . $this_page_first_result . ',' . $result_per_page;
$rslt = mysqli_query($connect, $sql);
        ...
        <div class="column is-offset-5">
            <nav class="pagination" role="navigation" aria-label="pagination">
                ...
                ?>
                    ...
                    <?php
                    echo '<li><a class="pagination-link is-current" href="landing_rec.php?page=' . $page . '">' . $page . '</a></li> ';
                }
                    ?>
                    <li>
