...
$query = " SELECT * FROM `congé`,`employer` WHERE etat='valide'  ";
...
$query = "SELECT * FROM `congé` WHERE etat='valide' LIMIT " . $this_page_first_result . ',' . $result_per_page;
$query_run = mysqli_query($connect, $query);
            ...
            <div class="column">
                ...
                <div class="column">
                    ...
                    <div class="table-container">
                        <p class="title is-9">Congé Valider</p>
                        <div class="table-container">
                ...
                <div class="column">
                    <nav class="pagination" role="navigation" aria-label="pagination">
                        ...
                        ?>
                            ...
                            <?php
                            echo '<li><a class="pagination-link is-current " href="conger_valid.php?page=' . $page . '">' . $page . '</a></li> ';
                        }
                        //  }
                            ?>
                            <li>
