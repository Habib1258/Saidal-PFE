...
$query = " SELECT * FROM `congé` WHERE etat='refus'  ";
...
$query = "SELECT * FROM `congé` WHERE etat='refus' LIMIT " . $this_page_first_result . ',' . $result_per_page;
$query_run = mysqli_query($connect, $query);
            ...
            <div class="column">
                ...
                <div class="column">
                    ...
                    <div class="table-container">
                        <p class="title is-9">Congé Refuser</p>
                        <div class="table-container">
                ...
                <div class="column">
                    <nav class="pagination" role="navigation" aria-label="pagination">
                        ...
                        ?>
                            ...
                            <?php
                            echo '<li><a class="pagination-link is-current " href="conger_refus.php?page=' . $page . '">' . $page . '</a></li> ';
                        }
                        //  }
                            ?>
                            <li>
