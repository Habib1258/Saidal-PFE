...
$query = " SELECT * FROM `affectation`, `employer` WHERE etat='refus'  ";
...
$query = "SELECT * FROM `affectation`, `employer` WHERE etat='refus' LIMIT " . $this_page_first_result . ',' . $result_per_page;
$query_run = mysqli_query($connect, $query);
            ...
            <div class="column">
                ...
                <div class="column">
                    ...
                    <div class="table-container">
                        <p class="title is-9">Affectation Refusé</p>
                        <div class="table-container">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="button is-danger"><?php echo $row['etat']; ?></p>
                                                </td>
                                            </tr>
                                </tbody>
                ...
                <div class="column">
                    <nav class="pagination" role="navigation" aria-label="pagination">
                        ...
                        ?>
                            ...
                            <?php
                            echo '<li><a class="pagination-link is-current " href="affect_refus.php?page=' . $page . '">' . $page . '</a></li> ';
                        }
                        //  }
                            ?>
                            <li>
